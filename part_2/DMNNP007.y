...
%token VAR INTEGER BOOLEAN CHAR REAL PROGRAM BEGIN_STMT END_STMT WRITE READ IF ELSE THEN AND OR NOT WHILE DO DOWNTO TO FOR ARRAY OF DIV TRUR_CONST FALSE_CONST
...
%type<float_int> arithmetic_statement arithmetic_statement_helper number_const expression_statement 
...
arithmetic_statement_helper: '+' arithmetic_statement {$$=$2;}
...
logical_expression : NOT logical_expression
  | '(' logical_expression ')'
  | NOT variable
  |arithmetic_statement_helper '>' arithmetic_statement_helper
  | arithmetic_statement_helper '>' '=' arithmetic_statement_helper
  | arithmetic_statement_helper '<' '=' arithmetic_statement_helper
  | arithmetic_statement_helper '<' arithmetic_statement_helper
  | arithmetic_statement_helper '=' arithmetic_statement_helper
...
loop_statement : WHILE logical_expression_helper DO program_block
  | FOR assignment_statement TO arithmetic_statement_helper DO program_block
  | FOR assignment_statement DOWNTO arithmetic_statement_helper DO program_block
  ;
